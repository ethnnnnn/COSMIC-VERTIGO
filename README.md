...
To see some loose plans for the future of the project, please refer to Plans.txt. We use this as a casual communication/notes file and to organize our thoughts. There's definitely some outdated stuff in there, but it should also have some relevant ideas or issues.
